class profile::tce_estacion {
  ...
  #class { 'gdm':
  #  package         => 'SUNWgnome-display-mgr',
  #  config_file     => '/etc/X11/gdm/gdm.conf',
  #  autologin       => true,
  #  autologin_user  => 'metro',
  #  autologin_delay => '10',
  #  server_name     => 'Standard',
  #  server_cmd      => '/usr/bin/X11/Xserver',
  #}
...
#  file { '/etc/openwin/server/etc/OWconfig':
#    ensure => present,
#    source => 'puppet:///modules/metro/tce/OWconfig',
#    owner  => 'root',
#    group  => 'root',
#    mode   => '0644',
#  } 
